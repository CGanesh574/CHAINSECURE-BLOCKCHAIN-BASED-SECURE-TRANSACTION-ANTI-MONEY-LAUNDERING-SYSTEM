...
const SupportCenter: React.FC = () => {
  ...
  const handleDownloadDocument = async (ticketId: string, index: number, filename: string) => {
    try {
  ...
  if (loading) {
    return <div className="support-center-loading">Loading support center...</div>;
  }
                  ...
                  <div className="documents-list">
                    {selectedTicket.documents.map((doc, index) => (
                      <div key={index} className="document-item">
                        ...
                        <button onClick={() => handleDownloadDocument(selectedTicket.ticketId, index, doc.originalName)}>
                          Download
                        </button>
                      </div>
                    ))}
